...
namespace Quản_lý_Sản_Phẩm.DataAcess__DAL_
{
        public class DataProvider
        {
            private string connectionString = "Data Source=DESKTOP-636OIPO;Initial Catalog=QuanLyBanHang;Integrated Security=True";
